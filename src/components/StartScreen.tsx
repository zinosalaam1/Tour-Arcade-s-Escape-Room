                ...
                >
                  <div className="grid grid-cols-4 gap-4 text-center">
                    <div className="space-y-1">
                      ...
                      <div className="text-xs text-slate-400">Security Lobby</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-2xl">🔌</div>
                      <div className="text-xs text-slate-400">Server Core</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-2xl">⚡</div>
                    ...
                    <div className="space-y-1">
                      <div className="text-2xl">🏆</div>
                      <div className="text-xs text-slate-400">The Vault</div>
                    </div>
                  </div>
                </motion.div>
              </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm">
                            ...
                            classified data before the 60-minute timer runs out.
                          </p>
                        </div>
                      </div>

                      <div className="bg-slate-950 rounded-lg p-4 border border-slate-800">
                        <h3 className="text-amber-400 mb-3">The 4 Rooms:</h3>
